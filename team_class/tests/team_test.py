...
class TestTeam(unittest.TestCase):
    ...
    def test_change_team_name(self):
        self.team.name = "Los Angeles Lakers"
        self.assertEqual("Los Angeles Lakers", self.team.name)

    def test_players_injured(self):
        self.team.players_injured(["Junior Bevil", "Yul Brenner"])
        self.assertEqual(2, self.team.injured)
